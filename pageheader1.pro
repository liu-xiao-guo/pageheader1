...
UBUNTU_TRANSLATION_DOMAIN="pageheader1.liu-xiao-guo"
...
aptest.commands = bash $$PWD/pageheader1/tests/autopilot/run
aptest.depends  = sub-pageheader1

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/pageheader1/tests/unit
unittest.depends  = sub-pageheader1
